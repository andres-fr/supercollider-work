...
int main(){
  ...
  DoubleSignal* ds1 = new DoubleSignal(ANALYSIS_DIR+"cc_m60_m200.txt");
  DoubleSignal* ds2 = new DoubleSignal(ANALYSIS_DIR+"cc_original_m60.txt");

  ds1->setSFInfo(ds1->length(), 44100, 1, 65538, 1, 1);
  ds2->setSFInfo(ds2->length(), 44100, 1, 65538, 1, 1);

  ds1->toNormalizedWav("orig_60.wav");
  ds2->toNormalizedWav("200_60.wav");
